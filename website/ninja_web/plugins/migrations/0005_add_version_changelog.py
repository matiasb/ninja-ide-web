...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PluginDownload.changelog'
        db.add_column('plugins_plugindownload', 'changelog', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PluginDownload.changelog'
        db.delete_column('plugins_plugindownload', 'changelog')
    ...
    models = {
        ...
        'plugins.plugindownload': {
            'Meta': {'ordering': "('-version',)", 'object_name': 'PluginDownload'},
