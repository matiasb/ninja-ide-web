...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Plugin.upload_date'
        db.delete_column('plugins_plugin', 'upload_date')

        # Deleting field 'Plugin.zip_file'
        db.delete_column('plugins_plugin', 'zip_file')


    def backwards(self, orm):
        
        # Adding field 'Plugin.upload_date'
        db.add_column('plugins_plugin', 'upload_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today), keep_default=False)

        # Adding field 'Plugin.zip_file'
        db.add_column('plugins_plugin', 'zip_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)
