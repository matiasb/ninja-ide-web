...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PluginDownload'
        db.create_table('plugins_plugindownload', (
        ...
        db.send_create_signal('plugins', ['PluginDownload'])


    def backwards(self, orm):
        
        # Deleting model 'PluginDownload'
        db.delete_table('plugins_plugindownload')
